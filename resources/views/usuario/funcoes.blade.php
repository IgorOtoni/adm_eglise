...
$(function(){
    ...
    var table = $('#tbl_funcoes').DataTable({
        'paging'      : true,
        'lengthChange': true,
        'searching'   : true,
        'ordering'    : true,
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '{{route('usuario.tbl_funcoes')}}',
        'columns': [
                {
    ...
    $('#tbl_funcoes tbody').on('click', 'td.details-control', function () {
...
<section class="content">
    ...
    <div class="box-header with-border">
        ...
        <?php if( valida_permissao(\Auth::user()->id_perfil, \Config::get('constants.modulos.funcoesg'), \Config::get('constants.permissoes.incluir'))[2] == true){ ?>
            <div class="pull-right">
            <a class="btn btn-success" data-toggle="modal" data-target="#modal-incluir"><i class="fa fa-plus"></i>&nbspIncluir função</a>
            </div>
        <?php } ?>
    </div>
    <div class="box-body">
        <table id="tbl_funcoes" class="table table-bordered table-striped">
        <thead>
        <tr>
            <th>Expandir</th>
            <th>#</th>
...
<form id="incluirFuncaoFormulario" data-toggle="validator" method="POST" role="form" action="{{route('usuario.incluirFuncao')}}" enctype="multipart/form-data">
@csrf
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="form-group has-feedback">
                        <div class="radio">
                            <label>
                                <input name="apresentar" type="radio" required>
