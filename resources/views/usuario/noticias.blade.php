...
$(function(){
    ...
    var table = $('#tbl_noticias').DataTable({
        'paging'      : true,
        'lengthChange': true,
        'searching'   : true,
        'ordering'    : true,
        ...
        'autoWidth': false,
        //'serverSide': false,
        'ajax': '{{route('usuario.tbl_noticias')}}',
        'columns': [
                {
    ...
    $('#tbl_noticias tbody').on('click', 'td.details-control', function () {
...
<section class="content-header">
    <h1>
    Notícias
    <small>Lista de todas as notícias da congregação</small>
    </h1>
</section>
...
<section class="content">
    ...
    <div class="box-header with-border">
        ...
        <?php if( valida_permissao(\Auth::user()->id_perfil, \Config::get('constants.modulos.noticiasg'), \Config::get('constants.permissoes.incluir'))[2] == true){ ?>
            <div class="pull-right">
            <a class="btn btn-success" data-toggle="modal" data-target="#modal-incluir"><i class="fa fa-plus"></i>&nbspIncluir notícia</a>
            </div>
        <?php } ?>
    </div>
    <div class="box-body">
        <table id="tbl_noticias" class="table table-bordered table-striped">
        <thead>
        <tr>
            <th></th>
            <th>#</th>
...
<form id="incluirNoticiaFormulario" data-toggle="validator" method="POST" role="form" action="{{route('usuario.incluirNoticia')}}" enctype="multipart/form-data">
@csrf
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title">Incluir notícia</h4>
        </div>
            ...
            <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="form-group has-feedback">
                        <label >Título</label>
                        <input name="nome" type="text" class="form-control" placeholder="Título" required>
