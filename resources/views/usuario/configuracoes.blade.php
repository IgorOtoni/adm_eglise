...
$(function(){
    ...
    $('input[type=file]').fileinput({
        ...
        initialPreviewConfig: [
            {caption: "{{$igreja->logo}}", extra: {id: {{$igreja->id}}, logo: "{{$igreja->logo}}", _token: $("#csrf_token").val()}, size: 215000, width: "120px", url: "/usuario/excluirLogo", key: 1},
        ],
        <?php } ?>
                                        ...
                                        <div><span><i class="icon-folder-open"></i> {{$menu->ordem}} - {{$menu->nome}}</span> 
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <?php if( valida_permissao(\Auth::user()->id_perfil, \Config::get('constants.modulos.configuracoesg'), \Config::get('constants.permissoes.desativar'))[2] == true){ ?>
                                                    <a class="btn btn-danger btn-sm" href="/usuario/excluirMenu/{{$menu->id}}"><i class="fa fa-trash"></i> Menu</a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <ul>
                                                ...
                                                <li>
                                                    <div><span><i class="icon-minus-sign"></i> {{$submenu->ordem}} - {{$submenu->nome}}</span>
                                                        ...
                                                        <div class="pull-right">
                                                            ...
                                                            <?php } ?>
                                                            <?php if( valida_permissao(\Auth::user()->id_perfil, \Config::get('constants.modulos.configuracoesg'), \Config::get('constants.permissoes.desativar'))[2] == true){ ?>
                                                                <a class="btn btn-danger btn-sm" href="/usuario/excluirSubMenu/{{$submenu->id}}"><i class="fa fa-trash"></i> Submenu</a>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                    <ul>
                                                            ...
                                                            <li>
                                                                <div><span><i class="icon-leaf"></i> {{$subsubmenu->ordem}} - {{$subsubmenu->nome}}</span> 
                                                                    ...
                                                                    <div class="pull-right">
                                                                        ...
                                                                        <?php } ?>
                                                                        <?php if( valida_permissao(\Auth::user()->id_perfil, \Config::get('constants.modulos.configuracoesg'), \Config::get('constants.permissoes.desativar'))[2] == true){ ?>
                                                                            <a class="btn btn-danger btn-sm" href="/usuario/excluirSubSubMenu/{{$subsubmenu->id}}"><i class="fa fa-trash"></i> Sub-Submenu</a>
                                                                        <?php } ?>
                                                                    </div>
                                                                </div>
                                                            </li>
                                    ...
                                    <li>
                                        <div><span><i class="icon-folder-open"></i> {{$menu->ordem}} - {{$menu->nome}}</span> 
                                            ...
                                            <div class="pull-right">
                                                ...
                                                <?php } ?>
                                                <?php if( valida_permissao(\Auth::user()->id_perfil, \Config::get('constants.modulos.configuracoesg'), \Config::get('constants.permissoes.desativar'))[2] == true){ ?>
                                                    <a class="btn btn-danger btn-sm" href="/usuario/excluirMenuAplicativo/{{$menu->id}}"><i class="fa fa-trash"></i> Menu</a>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </li>
